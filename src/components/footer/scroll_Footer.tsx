...
const Preview: React.FC = () => {
  return (
    <div className="w-full bg-[#0c0c0c] items-center justify-center h-full overflow-auto">
      ...
      <div className="sticky z-100 bottom-0 left-0 w-full h-80 bg-[#0c0c0c] flex justify-center items-center">
        <div className="relative overflow-hidden w-full h-full flex justify-end px-12 text-right items-start py-12 text-[#F0F1F2]">
          ...
          <h2 className="absolute bottom-4 left-0  translate-y-1/3 sm:text-[192px]  text-[80px] text-[#0f1112] font-calendas">
            Gaurav Gupta
          </h2>
        </div>
      </div>
